...
def _center_plane_before_next_stage(
    ...
    for step in range(1, max_steps + 1):
        ...
        last_action = _apply_centering_priority(ctrl, decision, snapshot["altitude"], min_altitude=altitude_target)
...
def run_task_with_grounding_sam(
    ...
    try:
        ...
        for step in range(1, max_area_steps + 1):
            ...
            last_action = _apply_centering_priority(ctrl, decision, snapshot["altitude"], min_altitude=PLANE_LOCK_ALTITUDE)
            _sleep_between_steps()
        else:
        ...
        for step in range(1, MAX_EVAL_CENTER_STEPS + 1):
            ...
            last_action = _apply_centering_priority(ctrl, eval_decision, snapshot["altitude"], min_altitude=PLANE_EVAL_ALTITUDE)
            _sleep_between_steps()
